...
| `skills/automated-assessment/assets/llm-rubric-repo-health.md` | LLM review rubrics |
...
- **Checkpoint IDs**: `{PREFIX}-{NUMBER}` (SR- for skill-repo, GH- for github-project, etc.)
